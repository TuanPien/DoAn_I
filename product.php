                    ...
                    <div class="product-content-right">
                        ...
                        <div class="product-content-right-product-button">
                            <a href="campaign.php?user_id=<?php echo $user_id?>&product_id=<?php echo $product_id?>">
                                <button><i class="fa-solid fa-cart-shopping"></i><p>Tìm chiến dịch</p></button></a>
                        </div>
            ...
            <div class="product-content row">
                ...
                <a href="product.php?product_id=<?php echo $temp['product_id']?>&user_id=<?php echo $user_id?>">
                    <div class="product-related-item">
                        <img src="admin/uploads/<?php echo $temp['product_main_image']?>">
                        <h1><?php echo $temp['product_name']?></h1>
                        <p style="color: black"><?php echo $temp['product_price']?><sup>đ</sup></p> <p><?php echo $temp['product_sale_price']?><sup>đ</sup></p>
                    </div>
                </a>
                <?php
                    }
