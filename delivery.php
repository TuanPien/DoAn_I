    ...
    <form action="" method="POST">
        <div class="delivery-content row">
            ...
            <div class="delivery-content-left-button row">
                ...
                <button class="button" type="submit">Thanh toán và giao hàng </button>
            </div>
        </div>
    </form>
    <div class="delivery-content-right">
        <table>
            ...
            <tr>
                ...
                <td><?php echo $temp_order['price_discount']?><sup>đ</sup></td>
            </tr>
            <tr>
                <td colspan="3" style="font-weight: bold; color: red;">Tiền cọc</td>
                <td style="font-weight: bold; color: red;"><p><?php echo $temp_order['down_payment']?><sup>đ</sup></p></td>
            </tr>
            <tr>
                <td colspan="3" style="font-weight: bold;">Thanh toán còn lại</td>
                <td style="font-weight: bold;"><p><?php echo ($temp_order['price_discount']-$temp_order['down_payment']) ?><sup>đ</sup></p></td>
            </tr>
        </table>
    </div>
</div>
