...
const thongtin = document.querySelector(
  ".product-content-right-bottom-content-title-item thongtin"
);
const script = document.querySelector(
  ".product-content-right-bottom-content-title-item script"
);

if (script) {
  script.addEventListener("click", function () {
    document.querySelector(
      ".product-content-right-bottom-content-thongtin"
    ).style.display = "none";
    document.querySelector(
      ".product-content-right-bottom-content-script"
    ).style.display = "block";
  });
}
