            ...
            <div class="admin-content-right-category-list">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><a class="normal_link" href="edit_discount.php?discount_id=<?php echo $result['discount_id'] ?>">Sửa</a> | 
                        <a class="normal_link" href="delete_discount.php?discount_id=<?php echo $result['discount_id'] ?>">Xoá</a></td>
                    </tr>
                    <?php
                        }
                    }
