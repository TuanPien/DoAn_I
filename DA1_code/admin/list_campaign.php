            ...
            <div class="admin-content-right-category-list" style="width: 98%;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $result['product_name']?> <br> #<?php echo $result['product_id']?></td>
                        <td><?php echo $result['discount_value']?>%</td>
                        <td><?php echo $result['product_sum']?></td>
                        <td><?php echo $fm -> format_currency($result['product_value_discount']) ?></td>
                        <td><?php echo $fm -> format_currency($result['total_value_discount']) ?></td>
                        <td><?php echo $result['time_start']?></td>
                        <td><?php echo $result['time_end']?></td>
                        <td><a class="normal_link" href="edit_campaign.php?user_id=<?php echo $user_id?>&campaign_id=<?php echo $result['campaign_id']?>">Sửa</a> | <a class="normal_link" href="delete_campaign.php?user_id=<?php echo $user_id?>&campaign_id=<?php echo $result['campaign_id']?>">Xoá</a></td>
                    </tr>
                    <?php
                        }
                    }
