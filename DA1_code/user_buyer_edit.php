...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    $update_user = $user->update_user($user_id);
}
?>
...
<body>
    ...
    <div class="navbar-top">
        <div class="title">
            <h1 style="font-family: 'Dancing Script', cursive;">Chỉnh sửa thông tin</h1>
        </div>
        <!-- Navbar -->
        <ul>
            <li>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>Tên</td>
                                <td>:</td>
                                <td><input class="text_input" type="text" name="user_name" value="<?php echo $result['user_name'] ?>"></td>
                            </tr>
                            <tr>
                                <td>Địa chỉ</td>
                                <td>:</td>
                                <td><input class="text_input" type="text" name="user_address" value="<?php echo $result['user_address'] ?>"></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>:</td>
                                <td><input class="text_input" type="text" name="user_email" value="<?php echo $result['user_email'] ?>"></td>
                            </tr>
                            <tr>
                                <td>Số điện thoại</td>
                                <td>:</td>
                                <td><input class="text_input" type="text" name="user_phone" value="<?php echo $result['user_phone'] ?>"></td>
                            </tr>
                            <tr>
                                <td>Ngày sinh</td>
                                <td>:</td>
                                <td><input class="text_input" type="date" name="user_dob" value="<?php echo $result['user_dob'] ?>"></td>
                            </tr>
                            <tr>
                                <td>Mật khẩu</td>
                                <td>:</td>
                                <td><input class="text_input" type="password" name="user_password" placeholder="Nhập mật khẩu để cập nhật" required></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    ?>
        <div class="alert">
            ...
            <strong>Sai mật khẩu!</strong> Vui lòng nhập lại
        </div>
    <?php
        }
    }
